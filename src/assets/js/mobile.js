const loadMobileJs = setInterval(function() {
    const mobileWalletContainer = $('#wallet-type-mobile');
    if (mobileWalletContainer && mobileWalletContainer.data('connected') != undefined) {
      init();
      clearInterval(loadMobileJs);
    }
}, 500);

const MOBILE_OVERLAY_COOKIE_NAME = 'mobile-wallet-overlay-dismissed';
